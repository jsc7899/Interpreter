...
print(num_uninitialized(content))
print(num_invalid_read(content))
print(num_invalid_write(content))
print(num_invalid_free(content))
print(num_memory_leak(content))
